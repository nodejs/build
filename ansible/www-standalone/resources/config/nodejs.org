...
server {
    ...
    location @english_404 {
        alias /home/www/nodejs/404/index.html;
...
server {
    ...
    location / {
        ...
        try_files $uri $uri/ @english_fallback =404;
    ...
    location @localized_404 {
        try_files /$lang/404/index.html /404/index.html;
