...
server {
    ...
    location /dist {
        ...
        # Make it possible for javascript on any website to download the installer files and use the data.
        ...
        # JSON files are now covered by the general CORS settings directly above
        #location ~ \.json$ {
        #    add_header access-control-allow-origin *;
        #}
    }
