...
OSTYPE=linux-gnu nohup java -jar slave.jar -jnlpUrl https://jenkins-iojs.nodesource.com/computer/iojs-digitalocean-centos5-64-gcc41-{{gcc41_id}}/slave-agent.jnlp -secret {{gcc41_secret}} &
