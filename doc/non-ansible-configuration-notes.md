...
1. Stop the concerned Jenkins systemd service(s)
2. Disable the concerned Jenkins systemd service(s)
3. Remove the Jenkins systemd service configuration
...
6. Clean up unnecessary Docker images
